...
//t.executeUpdate("create table courses(CourseID int(100),Course_Name varchar(200) ,Course_Category varchar(200),Course_Description varchar(500),Course_Duration varchar(100),Course_Link varchar(200))");
st.executeUpdate("create table quiz(QuestionID int(100),Question_Categry varchar(200),Quiz_Question varchar(200) ,Option1 varchar(200),Option2 varchar(500),Option3 varchar(100),Option4 varchar(200), Answer varchar(200))");
